...
var indexApp = (function () {
    ...
    function create_if_block_10(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 71, 23, 2204);
    			attr_dev(li0, "class", "ml-8");
    			add_location(li0, file, 71, 6, 2187);
    			...
    			add_location(button1, file, 72, 23, 2447);
    			attr_dev(li1, "class", "ml-8");
    			add_location(li1, file, 72, 6, 2430);
    			...
    			add_location(button2, file, 73, 23, 2690);
    			attr_dev(li2, "class", "ml-8");
    			add_location(li2, file, 73, 6, 2673);
    			...
    			add_location(button3, file, 74, 23, 2927);
    			attr_dev(li3, "class", "ml-8");
    			add_location(li3, file, 74, 6, 2910);
    			add_location(ul, file, 70, 5, 2175);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(70:4) {#if dropdowns.season}",
    		ctx
    	});
    ...
    function create_if_block_14(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(72:193) {#if $seasons.spring}",
    		ctx
    	});
    ...
    function create_if_block_13(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(73:193) {#if $seasons.summer}",
    		ctx
    	});
    ...
    function create_if_block_11(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(75:193) {#if $seasons.winter}",
    		ctx
    	});
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block2) if_block2.c();
    			attr_dev(button0, "class", "flex justify-between items-center w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button0, file, 87, 23, 3746);
    			attr_dev(li0, "class", "ml-8");
    			add_location(li0, file, 87, 6, 3729);
    			attr_dev(button1, "class", "flex justify-between items-center w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button1, file, 88, 23, 3989);
    			attr_dev(li1, "class", "ml-8");
    			add_location(li1, file, 88, 6, 3972);
    			attr_dev(button2, "class", "flex justify-between items-center w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button2, file, 89, 23, 4250);
    			attr_dev(li2, "class", "ml-8");
    			add_location(li2, file, 89, 6, 4233);
    			add_location(ul, file, 86, 5, 3717);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    			append_dev(ul, li0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(86:4) {#if dropdowns.holiday}",
    		ctx
    	});
    ...
    function create_if_block_9(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(88:193) {#if $holiday.easter}",
    		ctx
    	});
    ...
    // (89:205) {#if $holiday.thanksgiving}
    function create_if_block_8(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(89:205) {#if $holiday.thanksgiving}",
    		ctx
    	});
    ...
    function create_if_block_7(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(90:199) {#if $holiday.christmas}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block2) if_block2.c();
    			attr_dev(button0, "class", "flex justify-between items-center w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button0, file, 102, 23, 5071);
    			attr_dev(li0, "class", "ml-8");
    			add_location(li0, file, 102, 6, 5054);
    			attr_dev(button1, "class", "flex justify-between items-center w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button1, file, 103, 23, 5310);
    			attr_dev(li1, "class", "ml-8");
    			add_location(li1, file, 103, 6, 5293);
    			attr_dev(button2, "class", "flex justify-between items-center w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button2, file, 104, 23, 5540);
    			attr_dev(li2, "class", "ml-8");
    			add_location(li2, file, 104, 6, 5523);
    			add_location(ul, file, 101, 5, 5042);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    			append_dev(ul, li0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(101:4) {#if dropdowns.style}",
    		ctx
    	});
    ...
    function create_if_block_5(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(103:191) {#if $style.modern}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 121, 6, 6437);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "flex justify-between items-center w-4/5 mx-auto text-left py-4 mt-32 bg-dark-200 border border-white rounded-lg");
    			add_location(div, file, 129, 3, 6588);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    			mount_component(cross, div, null);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(129:2) {#if $seasons.spring}",
    		ctx
    	});
