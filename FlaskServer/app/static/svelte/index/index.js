...
var indexApp = (function () {
    ...
    function uploadImage(image, promt="cute squirrel", sampler = "Euler a", steps = 20, cfg_scale=7.0) {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button0, file, 53, 23, 2345);
    			attr_dev(li0, "class", "ml-8");
    			add_location(li0, file, 53, 6, 2328);
    			attr_dev(button1, "class", "w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button1, file, 54, 23, 2481);
    			attr_dev(li1, "class", "ml-8");
    			add_location(li1, file, 54, 6, 2464);
    			attr_dev(button2, "class", "w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button2, file, 55, 23, 2611);
    			attr_dev(li2, "class", "ml-8");
    			add_location(li2, file, 55, 6, 2594);
    			add_location(ul, file, 52, 5, 2317);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    			append_dev(ul, li0);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button0, file, 68, 23, 3301);
    			attr_dev(li0, "class", "ml-8");
    			add_location(li0, file, 68, 6, 3284);
    			attr_dev(button1, "class", "w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button1, file, 69, 23, 3431);
    			attr_dev(li1, "class", "ml-8");
    			add_location(li1, file, 69, 6, 3414);
    			attr_dev(button2, "class", "w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button2, file, 70, 23, 3558);
    			attr_dev(li2, "class", "ml-8");
    			add_location(li2, file, 70, 6, 3541);
    			add_location(ul, file, 67, 5, 3273);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    			append_dev(ul, li0);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 99, 4, 4868);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 96, 4, 4664);
    			attr_dev(p, "class", "text-xs");
    			add_location(p, file, 97, 4, 4768);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file, 94, 2, 4497);
    			attr_dev(input, "type", "file");
    			attr_dev(input, "accept", "image/**");
    			attr_dev(input, "id", "filepicker");
    			set_style(input, "display", "none");
    			add_location(input, file, 102, 2, 5008);
