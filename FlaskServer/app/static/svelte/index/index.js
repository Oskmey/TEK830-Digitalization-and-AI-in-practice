...
var indexApp = (function () {
    ...
    function create_if_block_13(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 152, 23, 4596);
    			attr_dev(li0, "class", "ml-8");
    			add_location(li0, file, 152, 6, 4579);
    			...
    			add_location(button1, file, 153, 23, 4838);
    			attr_dev(li1, "class", "ml-8");
    			add_location(li1, file, 153, 6, 4821);
    			...
    			add_location(button2, file, 154, 23, 5080);
    			attr_dev(li2, "class", "ml-8");
    			add_location(li2, file, 154, 6, 5063);
    			...
    			add_location(button3, file, 155, 23, 5316);
    			attr_dev(li3, "class", "ml-8");
    			add_location(li3, file, 155, 6, 5299);
    			add_location(ul, file, 151, 5, 4568);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(151:4) {#if dropdowns.season}",
    		ctx
    	});
    ...
    function create_if_block_17(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(153:193) {#if $seasons.spring}",
    		ctx
    	});
    ...
    function create_if_block_16(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(154:193) {#if $seasons.summer}",
    		ctx
    	});
    ...
    function create_if_block_15(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(155:189) {#if $seasons.fall}",
    		ctx
    	});
    ...
    function create_if_block_14(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(156:193) {#if $seasons.winter}",
    		ctx
    	});
    ...
    function create_if_block_9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block2) if_block2.c();
    			attr_dev(button0, "class", "flex justify-between items-center w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button0, file, 168, 23, 6122);
    			attr_dev(li0, "class", "ml-8");
    			add_location(li0, file, 168, 6, 6105);
    			attr_dev(button1, "class", "flex justify-between items-center w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button1, file, 169, 23, 6364);
    			attr_dev(li1, "class", "ml-8");
    			add_location(li1, file, 169, 6, 6347);
    			attr_dev(button2, "class", "flex justify-between items-center w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button2, file, 170, 23, 6624);
    			attr_dev(li2, "class", "ml-8");
    			add_location(li2, file, 170, 6, 6607);
    			add_location(ul, file, 167, 5, 6094);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    			append_dev(ul, li0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(167:4) {#if dropdowns.holiday}",
    		ctx
    	});
    ...
    function create_if_block_12(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(169:193) {#if $holiday.easter}",
    		ctx
    	});
    ...
    // (170:205) {#if $holiday.thanksgiving}
    function create_if_block_11(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(170:205) {#if $holiday.thanksgiving}",
    		ctx
    	});
    ...
    function create_if_block_10(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(171:199) {#if $holiday.christmas}",
    		ctx
    	});
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block2) if_block2.c();
    			attr_dev(button0, "class", "flex justify-between items-center w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button0, file, 183, 23, 7432);
    			attr_dev(li0, "class", "ml-8");
    			add_location(li0, file, 183, 6, 7415);
    			attr_dev(button1, "class", "flex justify-between items-center w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button1, file, 184, 23, 7670);
    			attr_dev(li1, "class", "ml-8");
    			add_location(li1, file, 184, 6, 7653);
    			attr_dev(button2, "class", "flex justify-between items-center w-full text-left p-2 rounded transition ease-in-out hover:bg-dark-100");
    			add_location(button2, file, 185, 23, 7899);
    			attr_dev(li2, "class", "ml-8");
    			add_location(li2, file, 185, 6, 7882);
    			add_location(ul, file, 182, 5, 7404);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    			append_dev(ul, li0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(182:4) {#if dropdowns.style}",
    		ctx
    	});
    ...
    function create_if_block_8(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(184:191) {#if $style.modern}",
    		ctx
    	});
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 203, 7, 8730);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(203:6) {#if setting.showTooltip}",
    		ctx
    	});
    ...
    // (196:3) {#each advancedSettings as setting}
    function create_each_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file, 200, 6, 8636);
    			attr_dev(div, "class", "relative inline-block hover:cursor-pointer");
    			add_location(div, file, 197, 5, 8460);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(196:3) {#each advancedSettings as setting}",
    		ctx
    	});
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty[0] & /*$seasons*/ 64) && t0_value !== (t0_value = /*season*/ ctx[46].charAt(0).toUpperCase() + /*season*/ ctx[46].slice(1) + "")) set_data_dev(t0, t0_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(219:3) {#if $seasons[season]}",
    		ctx
    	});
    ...
    // (218:2) {#each Object.keys($seasons) as season}
    function create_each_block_2(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*$seasons*/ ctx[6][/*season*/ ctx[46]] && create_if_block_3(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*$seasons*/ ctx[6][/*season*/ ctx[46]]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(218:2) {#each Object.keys($seasons) as season}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(cross.$$.fragment);
    			attr_dev(button, "class", "rounded hover:bg-dark-200");
    			add_location(button, file, 230, 5, 9963);
    			attr_dev(div, "class", "flex justify-between bg-dark-200 items-center w-full p-2 mb-4 border border-white rounded");
    			add_location(div, file, 228, 4, 9767);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty[0] & /*$holiday*/ 128) && t0_value !== (t0_value = /*holi*/ ctx[43].charAt(0).toUpperCase() + /*holi*/ ctx[43].slice(1) + "")) set_data_dev(t0, t0_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(cross.$$.fragment, local);
    ...
    // (227:2) {#each Object.keys($holiday) as holi}
    function create_each_block_1(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*$holiday*/ ctx[7][/*holi*/ ctx[43]] && create_if_block_2(ctx);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(227:2) {#each Object.keys($holiday) as holi}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			attr_dev(button, "class", "rounded hover:bg-dark-200");
    			add_location(button, file, 239, 5, 10352);
    			attr_dev(div, "class", "flex justify-between bg-dark-200 items-center w-full p-2 mb-4 border border-white rounded");
    			add_location(div, file, 237, 4, 10157);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty[0] & /*$style*/ 256) && t0_value !== (t0_value = /*key*/ ctx[40].charAt(0).toUpperCase() + /*key*/ ctx[40].slice(1) + "")) set_data_dev(t0, t0_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(cross.$$.fragment, local);
    ...
    // (236:2) {#each Object.keys($style) as key}
    function create_each_block(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*$style*/ ctx[8][/*key*/ ctx[40]] && create_if_block_1(ctx);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(236:2) {#each Object.keys($style) as key}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 251, 4, 10970);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 248, 4, 10766);
    			attr_dev(p, "class", "text-xs");
    			add_location(p, file, 249, 4, 10870);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file, 246, 2, 10599);
    			attr_dev(input, "type", "file");
    			attr_dev(input, "accept", "image/**");
    			attr_dev(input, "id", "filepicker");
    			set_style(input, "display", "none");
    			add_location(input, file, 254, 2, 11110);
