...
var indexApp = (function () {
    ...
    function create_each_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 166, 8, 5643);
    			attr_dev(li, "class", "ml-8");
    			add_location(li, file, 165, 7, 5617);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file, 161, 215, 5400);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 191, 5, 6565);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_1(ctx) {
    	...
    	function input0_change_input_handler() {
    		/*input0_change_input_handler*/ ctx[21].call(input0, /*each_value_1*/ ctx[34], /*setting_index*/ ctx[35]);
    	}

    	function input1_input_handler() {
    		/*input1_input_handler*/ ctx[22].call(input1, /*each_value_1*/ ctx[34], /*setting_index*/ ctx[35]);
    	}

    	function blur_handler(...args) {
    		return /*blur_handler*/ ctx[23](/*setting*/ ctx[33], /*each_value_1*/ ctx[34], /*setting_index*/ ctx[35], ...args);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 188, 6, 6473);
    			attr_dev(div, "class", "relative inline-block hover:cursor-pointer");
    			add_location(div, file, 185, 4, 6299);
    			attr_dev(input0, "class", "hover:cursor-pointer");
    			attr_dev(input0, "type", "range");
    			attr_dev(input0, "min", input0_min_value = /*setting*/ ctx[33].min);
    			attr_dev(input0, "max", input0_max_value = /*setting*/ ctx[33].max);
    			attr_dev(input0, "step", input0_step_value = /*setting*/ ctx[33].step);
    			add_location(input0, file, 196, 4, 6806);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "min", input1_min_value = /*setting*/ ctx[33].min);
    			attr_dev(input1, "max", input1_max_value = /*setting*/ ctx[33].max);
    			attr_dev(input1, "step", input1_step_value = /*setting*/ ctx[33].step);
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*setting*/ ctx[33].value);
    			append_dev(li, t3);
    			append_dev(li, input1);
    			set_input_value(input1, /*setting*/ ctx[33].value);
    			append_dev(li, t4);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*advancedSettings*/ 8 && input0_min_value !== (input0_min_value = /*setting*/ ctx[33].min)) {
    				attr_dev(input0, "min", input0_min_value);
    			}

    			if (dirty[0] & /*advancedSettings*/ 8 && input0_max_value !== (input0_max_value = /*setting*/ ctx[33].max)) {
    				attr_dev(input0, "max", input0_max_value);
    			}

    			if (dirty[0] & /*advancedSettings*/ 8 && input0_step_value !== (input0_step_value = /*setting*/ ctx[33].step)) {
    			...
    			if (dirty[0] & /*advancedSettings*/ 8 && input1_min_value !== (input1_min_value = /*setting*/ ctx[33].min)) {
    				attr_dev(input1, "min", input1_min_value);
    			}

    			if (dirty[0] & /*advancedSettings*/ 8 && input1_max_value !== (input1_max_value = /*setting*/ ctx[33].max)) {
    				attr_dev(input1, "max", input1_max_value);
    			}

    			if (dirty[0] & /*advancedSettings*/ 8 && input1_step_value !== (input1_step_value = /*setting*/ ctx[33].step)) {
    				attr_dev(input1, "step", input1_step_value);
    			}

    			if (dirty[0] & /*advancedSettings*/ 8 && to_number(input1.value) !== /*setting*/ ctx[33].value) {
    				set_input_value(input1, /*setting*/ ctx[33].value);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block_2(ctx) {
    	...
    	function click_handler_2() {
    		return /*click_handler_2*/ ctx[24](/*category*/ ctx[30]);
    	}
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			img = element("img");
    			if (!src_url_equal(img.src, img_src_value = /*imageSrc*/ ctx[6])) attr_dev(img, "src", img_src_value);
    			...
    			add_location(img, file, 266, 5, 9797);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*imageSrc*/ 64 && !src_url_equal(img.src, img_src_value = /*imageSrc*/ ctx[6])) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 263, 5, 9590);
    			attr_dev(p, "class", "text-xs");
    			add_location(p, file, 264, 5, 9695);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file, 273, 6, 10540);
    			...
    			add_location(path1, file, 274, 6, 10938);
    			...
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			add_location(svg, file, 272, 5, 10374);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, svg, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*buttonText*/ 16) set_data_dev(t1, /*buttonText*/ ctx[4]);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(svg);
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (!/*imageSrc*/ ctx[6]) return create_if_block_1;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file, 261, 3, 9421);
    			attr_dev(input, "type", "file");
    			attr_dev(input, "accept", "image/**");
    			attr_dev(input, "id", "filepicker");
    			set_style(input, "display", "none");
    			add_location(input, file, 269, 3, 9940);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*click_handler_3*/ ctx[26], false, false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const blur_handler = (setting, each_value_1, setting_index, e) => {
    		...
    		if (isNaN(value) || e.target.value === '') {
    			...
    			$$invalidate(3, each_value_1[setting_index].value = setting.min, advancedSettings);
    			invalid = true;
    			...
    			$$invalidate(3, each_value_1[setting_index].value = setting.max, advancedSettings);
    			invalid = true;
    		} else {
    			$$invalidate(3, each_value_1[setting_index].value = value, advancedSettings);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*imageFile*/ 1) {
    			$$invalidate(6, imageSrc = imageFile ? URL.createObjectURL(imageFile) : '');
    		}
